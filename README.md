...
- **End-to-end latency** — with every optimization in this repo stacked, we cut a single round trip from ~4000ms to ~200ms against the upstream openpi server for one of our users. 
