...
- `serve.py` — Main server. Loads the policy, starts WebSocket thread, starts the openpi-flash-transport subprocess, wires them together via `ThreadSafePolicy`. This is the file to read first.
